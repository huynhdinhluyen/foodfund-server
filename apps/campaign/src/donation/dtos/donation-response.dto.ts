...
export class DonationResponse {
    ...
    @Field(() => String, { nullable: true, description: "Payment link ID for verification" })
        paymentLinkId?: string

    // Bank transfer information for manual payment
    @Field(() => String, { nullable: true, description: "Bank name (e.g., MB Bank)" })
        bankName?: string
    ...
    @Field(() => Number, { nullable: true, description: "Transfer amount in VND" })
        amount?: number
